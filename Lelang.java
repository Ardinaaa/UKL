...
public class Lelang { //variable
    ...
    public void prosesLelang(Petugas/*tipe data*/ petugas/*fariablem*/, Masyarakat masyarakat, Lelang lelang, Barang barang, Laporan laporan) {
...
//method
    ...
    public int getIdBarang(int id) { //method   
